...
namespace Festival.Data.Migrations
{
    ...
    [Migration("20200514230614_Removed bad relationship Purchase - PurchaseVoucher")]
    partial class RemovedbadrelationshipPurchasePurchaseVoucher
    {
            ...
            modelBuilder.Entity("Festival.Data.Models.Voucher", b =>
                {
                    ...
                    b.Property<int>("NumberOfRedeemedVouchers")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Festival.Data.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("Festival.Data.Models.TicketVoucher", "TicketVoucher")
                        .WithMany("RedeemedTicketsWithVouchers")
                        .HasForeignKey("TicketVoucherID");
                });
